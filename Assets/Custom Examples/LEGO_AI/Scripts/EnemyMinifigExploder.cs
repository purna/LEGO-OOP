...
{
    public static class EnemyMinifigExploder
    {
        ...
        public static void Explode(EnemyMinifig minifig, Transform leftArmTip, Transform rightArmTip, Transform leftLegTip, Transform rightLegTip, Transform head, Vector3 speed, float angularSpeed)
        {
            ...
            var leftHand = minifig.GetLeftHand();
            if (leftHand == null)
            {
                Debug.LogWarning("Left Hand is null. Skipping explosion for Left Hand.");
            }
            else
            {
            ...
            var rightHand = minifig.GetRightHand();
            if (rightHand == null)
            {
                Debug.LogWarning("Right Hand is null. Skipping explosion for Right Hand.");
            }
            else
            {
